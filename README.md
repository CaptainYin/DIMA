...
python train.py \
    ...
    --mode $wandb_log_mode \
    --sample_temp 20
python3 train.py  --n_workers 10  --env mamujoco  --env_name HalfCheetah-v2  --policy_class gaussian  --seed 0  --agent_conf 2x3  --steps 100000  --mode online  --sample_temp 20
python3 train.py  --n_workers 10  --env mamujoco  --env_name HalfCheetah-v2  --policy_class gaussian  --seed 0  --agent_conf 2x3  --steps 100000  --mode disabled  --sample_temp 20
python3 train.py  --n_workers 1  --env mamujoco  --env_name HalfCheetah-v2  --policy_class gaussian  --seed 0  --agent_conf 2x3  --steps 100000  --mode disabled  --sample_temp 20
python3 train.py  --n_workers 1  --env mamujoco  --env_name HalfCheetah-v2  --policy_class gaussian  --seed 0  --agent_conf 2x3  --steps 6000  --mode disabled  --sample_temp 20
CUDA_VISIBLE_DEVICES=0 python3 train.py  --n_workers 1  --env mamujoco  --env_name HalfCheetah-v2  --policy_class gaussian  --seed 0  --agent_conf 2x3  --steps 1000000  --mode online  --sample_temp 20
```
